package.preload["fenpoon.aniseed.fennel.repl"] = package.preload["fenpoon.aniseed.fennel.repl"] or function(...)
  local utils = require("fenpoon.aniseed.fennel.utils")
  local parser = require("fenpoon.aniseed.fennel.parser")
  local compiler = require("fenpoon.aniseed.fennel.compiler")
  local specials = require("fenpoon.aniseed.fennel.specials")
  local view = require("fenpoon.aniseed.fennel.view")
...
package.preload["fenpoon.aniseed.fennel.specials"] = package.preload["fenpoon.aniseed.fennel.specials"] or function(...)
  local utils = require("fenpoon.aniseed.fennel.utils")
  local view = require("fenpoon.aniseed.fennel.view")
  local parser = require("fenpoon.aniseed.fennel.parser")
  local compiler = require("fenpoon.aniseed.fennel.compiler")
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "fenpoon.aniseed.fennel.macros") or (package and package.loaded and ("table" == type(package.loaded[modname])) and (package.loaded[modname].metadata == compiler.metadata))) then
...
package.preload["fenpoon.aniseed.fennel.compiler"] = package.preload["fenpoon.aniseed.fennel.compiler"] or function(...)
  local utils = require("fenpoon.aniseed.fennel.utils")
  local parser = require("fenpoon.aniseed.fennel.parser")
  local friend = require("fenpoon.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
  local scopes = {}
...
package.preload["fenpoon.aniseed.fennel.friend"] = package.preload["fenpoon.aniseed.fennel.friend"] or function(...)
  local utils = require("fenpoon.aniseed.fennel.utils")
...
package.preload["fenpoon.aniseed.fennel.parser"] = package.preload["fenpoon.aniseed.fennel.parser"] or function(...)
  local utils = require("fenpoon.aniseed.fennel.utils")
  local friend = require("fenpoon.aniseed.fennel.friend")
  local unpack = (table.unpack or _G.unpack)
...
local utils
package.preload["fenpoon.aniseed.fennel.view"] = package.preload["fenpoon.aniseed.fennel.view"] or function(...)
...
package.preload["fenpoon.aniseed.fennel.utils"] = package.preload["fenpoon.aniseed.fennel.utils"] or function(...)
  local view = require("fenpoon.aniseed.fennel.view")
  local version = "1.2.1"
...
utils = require("fenpoon.aniseed.fennel.utils")
local parser = require("fenpoon.aniseed.fennel.parser")
local compiler = require("fenpoon.aniseed.fennel.compiler")
local specials = require("fenpoon.aniseed.fennel.specials")
local repl = require("fenpoon.aniseed.fennel.repl")
local view = require("fenpoon.aniseed.fennel.view")
...
do
  ...
  local module_name = "fenpoon.aniseed.fennel.macros"
  local _
