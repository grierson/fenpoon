...
local _2amodule_name_2a = "fenpoon.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("fenpoon.aniseed.compile"), autoload("fenpoon.aniseed.fennel"), autoload("fenpoon.aniseed.fs"), autoload("fenpoon.aniseed.nvim")
