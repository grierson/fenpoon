...
local _2amodule_name_2a = "harpoon.aniseed.env"
local _2amodule_2a
do
...
local compile, fennel, fs, nvim = autoload("harpoon.aniseed.compile"), autoload("harpoon.aniseed.fennel"), autoload("harpoon.aniseed.fs"), autoload("harpoon.aniseed.nvim")
